...
class DatabaseAccessObject():
    ...
    def get_all_obj(self):
        ...
        return {doc.id: self.class_.to_obj(**doc.to_dict()) for doc in
    ...
    def get_obj_by_id(self, id_value):
        ...
        return self.to_obj(**doc_dict)

    def add(self, obj):
        data = self.to_data(obj)
        self.dbm.add(self.collection, data)
...
class DataAccessObjectFactory:
    ...
    @classmethod
    def get_dao(cls, collection):
        return DatabaseAccessObject(
            collection,
            cls.collection_to_class_dict[collection]
        )
